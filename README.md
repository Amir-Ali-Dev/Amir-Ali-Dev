...
[![Email](https://img.shields.io/badge/Email-amiralihosseinzade169%40gmail.com-171717?style=flat-square&logo=gmail&logoColor=white)](mailto:amiralihosseinzade169@gmail.com)
[![Instagram](https://img.shields.io/badge/Instagram-hos.senzade-171717?style=flat-square&logo=instagram&logoColor=white)](https://instagram.com/hos.senzade)
...
<table>
  <tr>
    <td width="50%" valign="top">
      ...
      <p>A defensive security knowledge base and reproducible local lab for detecting, mitigating, and designing around denial-of-service attacks.</p>
      <p><strong>Inside:</strong> Nginx controls, NestJS rate limiting, Redis-backed coordination, Cloudflare patterns, Docker lab scenarios, case studies, checklists, and bilingual English/Persian documentation.</p>
      <p><code>Nginx</code> <code>NestJS</code> <code>Redis</code> <code>Docker</code> <code>Cloudflare</code></p>
    </td>
    <td width="50%" valign="top">
      <h3><a href="https://github.com/Amir-Ali-Dev/noir-liquid-glass">NOIR — Liquid Glass</a></h3>
      <p>A cinematic adaptive-audio concept built as a polished, dependency-free web experience.</p>
      <p><strong>Inside:</strong> lightweight liquid motion, deliberate responsive layouts, accessible interaction states, viewport-aware animation, and a live GitHub Pages deployment.</p>
      <p><code>HTML</code> <code>CSS</code> <code>JavaScript</code> · <a href="https://amir-ali-dev.github.io/noir-liquid-glass/">Live experience ↗</a></p>
    </td>
  </tr>
</table>
...
<sub>Tehran · Building in public on GitHub</sub>
